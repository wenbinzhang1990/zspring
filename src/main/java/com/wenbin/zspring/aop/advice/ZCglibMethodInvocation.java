...
public class ZCglibMethodInvocation implements ZMethodInvocation, ZJoinPoint {
  ...
  public ZCglibMethodInvocation(Object object, MethodProxy methodProxy, Object bean, Method method,
      Object[] args,
  ...
  public Object process() throws Throwable {
    if (index == this.advices.size() - 1) {
      return methodProxy.invokeSuper(this.object, this.args);
    }
